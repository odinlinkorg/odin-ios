...
public class HeaderVC: UIViewController {
    ...
    public override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        titleItem.title = Localized("扫一扫")
        titleItem.rightBarButtonItem?.title = Localized("相册")
    ...
    @IBAction func rightBarItemClick(_ sender: UIBarButtonItem) {
        delegate?.clickOpenPhoto()
    }
