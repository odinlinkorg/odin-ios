...
public class CameraVC: UIViewController {
    ...
    /// 识别二维码码图像
//    public func recognizeQRImage(image: UIImage, _ success:@escaping ((String)->())) {
    public func recognizeQRImage(image: UIImage) -> String {
...
extension CameraVC {
    ...
    func setupTorch() {
        ...
        flashBtn.frame = CGRect(x: (screenWidth - buttonSize)/2.0, y: scanView.contentView.frame.maxY-buttonSize-12, width: buttonSize, height: buttonSize)
