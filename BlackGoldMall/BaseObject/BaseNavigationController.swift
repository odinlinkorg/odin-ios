...
//        self.navigationBar.isTranslucent = true
        //背景颜色
        self.navigationBar.setBackgroundImage(UIImage.imageFromColor(color: tabbarBackgroundColor, viewSize: CGSize(width: kScreenWidth, height: 1)), for: UIBarPosition.any, barMetrics: UIBarMetrics.default)
        
        //设置底部线的颜色
        self.navigationBar.shadowImage = UIImage()
        
        let dict:NSDictionary = [NSAttributedString.Key.foregroundColor: UIColor.init(hex: 0x121212)]
